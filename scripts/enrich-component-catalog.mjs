...
const propTypes = {
  ...
  minItemMeasure: '"compact" | "default" | "wide"',
  minPaneMeasure: '"compact" | "default" | "wide"',
  measure: '"compact" | "default" | "wide" | "fill"',
  amount: "number",
  locale: "string",
...
const tokenSets = readJson(path.join(repoRoot, "generated/foundation.json"))
  .componentTokenRoles?.sets;
if (!tokenSets)
  throw new Error(
    "generated/foundation.json is missing component token roles; run pnpm contracts:generate first",
  );
