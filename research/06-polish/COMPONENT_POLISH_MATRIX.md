...
| Text entry      | Input, Textarea, SearchInput, NativeTimeInput, TimePicker        | native editing, labels, and bounded time selection       | Components route baselines    | responsive form grid      | pass   |
...
| Navigation      | Tabs, Pagination, Sidebar, NavigationMenu                        | arrows, Escape, focus-visible, nested menu semantics     | reference routes              | responsive shell          | pass   |
...
| Data display    | Card, Table, DataTable, KPICluster, MilestoneTracker, StatusChip | semantic rows, state, selection, and progress detail     | Operations stress suite       | mobile reference baseline | pass   |
