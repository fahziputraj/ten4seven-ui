...
export const curatedIconMetadata = {
  ...
  breakEven: {
    ...
    source: "@iconify-json/iconmind",
    icon: "break-even-duotone-regular",
    duotone: true,
  },
  equalRatio: {
