...
/*
 * Component catalog token roles are authored once here, then projected into
 * the AI catalog and consumed by the enrichment/verification scripts. The
 * catalog stores semantic role names; these targets document the runtime
 * custom properties they resolve to without making consumers depend on a
 * second, component-local token vocabulary.
 */
const tokenRoleSets = {
  foundation: [
    "font-ui",
...
export const COMPONENT_TOKEN_ROLE_CONTRACT = {
  ...
  targets: {
    ...
    background: ["--t7-background-hsl"],
    border: ["--t7-border-hsl"],
    "border-strong": ["--t7-border-strong-hsl"],
    "card-padding": ["--t7-card-padding"],
    "chart-1": ["--t7-chart-1-hsl"],
    "chart-2": ["--t7-chart-2-hsl"],
    ...
    "duration-loop": ["--t7-duration-loop"],
    "focus-ring": ["--t7-focus-ring"],
    "font-display": ["--t7-font-display"],
    ...
    "kpi-chart-height": ["--t7-kpi-chart-height"],
    "kpi-content-gap": ["--t7-kpi-content-gap"],
    "kpi-gap": ["--t7-kpi-gap"],
    "kpi-icon-container": ["--t7-kpi-icon-container"],
    "kpi-icon-size": ["--t7-kpi-icon-size"],
    "kpi-padding": ["--t7-kpi-padding"],
    "kpi-trend-padding-block": ["--t7-kpi-trend-padding-block"],
    "kpi-trend-padding-inline": ["--t7-kpi-trend-padding-inline"],
    motion: ["--t7-motion-state"],
    "motion-duration": ["--t7-motion-duration"],
    "motion-enter": ["--t7-motion-enter"],
    "motion-exit": ["--t7-motion-exit"],
    "motion-interactive": ["--t7-motion-interactive"],
    ...
    "shadow-card": ["--t7-shadow-card"],
    "shadow-modal": ["--t7-shadow-modal"],
    "shadow-popover": ["--t7-shadow-popover"],
    success: ["--t7-success-hsl"],
    surface: ["--t7-surface-hsl"],
    "surface-emphasis": [
      "--t7-surface-emphasis-plain-hsl",
      "--t7-surface-emphasis-soft-hsl",
      "--t7-surface-emphasis-solid-hsl",
      "--t7-surface-emphasis-inverse-hsl",
    ],
    ...
    "table-header-text": ["--t7-muted-foreground-hsl"],
    "touch-target-min": ["--t7-touch-target-min"],
    "transition-standard": ["--t7-transition-standard"],
    warning: ["--t7-warning-hsl"],
    "sticky-offset": ["--t7-doc-sticky-offset"],
    "z-sticky": ["--t7-z-sticky"],
  },
} as const;
