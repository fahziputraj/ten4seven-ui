...
| Component maturity           |          9 | Canonical ownership fixes for Card, AppShell, controls, overlays, and responsive navigation.                           | —                                                           |
...
| Overlay robustness           |          9 | Select/Combobox/Popover/Menu/Drawer/Modal/nested overlay tests pass.                                                   | —                                                           |
| Accessibility                |          8 | Landmark, labels, keyboard, focus restore, reduced motion, and axe evidence pass.                                      | Full narrated screen-reader study remains R-01.             |
